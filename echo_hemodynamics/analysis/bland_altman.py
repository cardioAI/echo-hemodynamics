...
def render_plain_bland_altman(
    ...
    for i, param_name in enumerate(param_names):
        ...
        cardio_utils.save_figure(
            fig, f"{prefix}_bland_altman_{param_name.lower()}", subdir="figures"
        )
        plt.close(fig)


def render_ph_stratified_bland_altman(
    ...
    for i, param_name in enumerate(param_names):
        ...
        ax.text(
            0.5,
            0.97,
            f"{prefix.title()}: {param_name} Bland-Altman Plot",
