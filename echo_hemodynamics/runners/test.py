...
def main():
    try:
        ...
        render_correlation_bar(
            ...
            PARAM_NAMES,
            cardio_utils,
            "test_parameter_correlations",
            "Test: Model Performance by Parameter",
        )
        render_correlation_bubble_heatmap(
            pred_denorm,
            PARAM_NAMES,
        ...
        render_ph_stratified_scatter(
            pred_denorm, targets, PARAM_NAMES, cardio_utils, "test"
        )
        render_ph_stratified_bland_altman(
            pred_denorm, targets, PARAM_NAMES, cardio_utils, "test"
        )
        render_heteroscedasticity_analysis(
            pred_denorm, targets, PARAM_NAMES, cardio_utils, output_dir
        )
