...
def create_fresh_model_for_variant(base_model, norm_params):
    fresh_model = create_model(
        num_outputs=9, num_frames=base_model.num_frames, num_views=4, dropout_rate=0.15
    )
